...
# ── Subcategory key → exact schema (100% reliable lookup) ─────────────────
# Used in service_selected BEFORE state.clear() via category_name from FSM.
# This guarantees correct schema regardless of service name wording.
SUBCATEGORY_TO_SCHEMA: Dict[str, ServiceSchema] = {
    "views_single":  SCHEMAS["просмотры на пост"],
    "views_multi":   SCHEMAS["последних постов"],
    "views_speed":   SCHEMAS["с выбором скорости"],
